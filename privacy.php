        ...
        <div id="imprint">
            <div style="max-width: 750px; width:100%; margin: 0px auto;">
                ...
                <p>More details regarding Google Hosted Libraries are available here:
                 ...
                 <p>This website uses Google Analytics, a web analytics service of Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA.
                     We use Google Analytics to create activity reports for our website. These reports are basis for analysing website usage, improving our service and the development of new services.
                 <p>
                 <p>Google Analytics utilizes cookies (see "Cookies") to perform an analysis of your use of our website. The use of Google Analytics takes place without registration. The IP address provided by your browser as part of Google Analytics will not be merged with other Google data.
                 </p>
                 <p>The privacy policy of Google can be found here:
                      <a class="underline" target="_blank" href="https://www.google.com/policies/privacy/">https://www.google.com/policies/privacy/</a>. </p>
                 <p>Further details regarding Google Analytics can be found here:
